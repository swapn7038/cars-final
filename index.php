...
<html lang="en">
  ...
  <body>
    ...
    <nav>
      ...
      <div>
      <button class="btn-login"><a href="./admin-panel/login.php">Login</a></button>
      <button class="btn-register"><a href="./admin-panel/signup.php">Sign Up</a></button>
      </div>
    </nav>
    <!-- ===== NAV END ===== -->
    <!-- ===== CAROUSAL ===== -->
  ...
  <div class="slider">
    ...
    <section class="about-us">
      ...
      <div class="about-us-info" >
        ...
        <div>
          <p>Our Software is the ideal way to manage complete garage workshop.</p>
          <p>The software has capability to generate jobcard for vehicle repair, <br> 
          process that and generate invoice and quotation for tha vehicle service repairs.</p>
        </div>
      </div>
    </section>
